...
public class Runner {
    ...
    public static Metro createMetro() throws LineException, StationException {
        ...
        Station permOne = metro.createLastStation("Красная", "Пермь 1", Duration.ofMinutes(3));
        ...
        metro.createLastStation("Синяя", "Тяжмаш", Duration.ofMinutes(1).plusSeconds(47), new ArrayList<>(List.of(permOne)));
